...
<section class="card">
  ...
  <ul class="quick-list">
    ...
    <li><strong>Mode contrast checks:</strong> explicit pass/fail assertions that Historical Prototype and Canonical v1.1.0 produce different outputs in targeted cases.</li>
