...
The Phalanx system is deployed through specialized formats, each tailored for different play styles.
...
- **Canonical Rules:** Game v1.4.0 defaults to competitive rules spec v3.0 with an 8-phase lifecycle, arithmetic provenance, and replay-verifiable outcomes.
...
**Phalanx: Arena** is a multiplayer expansion of the system, supporting more than two participants in free-for-all or team-based tactical combat.

### Phalanx: Siege

**Phalanx: Siege** is a scenario-driven format where players take on specialized tactical challenges, either cooperatively or competitively, within predefined game states and mission objectives.
