...
*   **For Bugs:** Use the [Bug Report Template](https://github.com/phalanxduel/phalanxduel/issues/new?template=bug_report.yml). Be as specific as possible about the board state and what you expected to happen versus what actually happened.
*   **For Balance/Mechanics:** Use the [Balance Proposal Template](https://github.com/phalanxduel/phalanxduel/issues/new?template=balance_proposal.yml). Do not just say "Spades are too strong." Explain *why*, provide an example from a match, and suggest a specific mathematical or timing change.
